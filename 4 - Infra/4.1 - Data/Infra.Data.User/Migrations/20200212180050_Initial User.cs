    ...
    public partial class InitialUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_address", x => new { x.user_id, x.zip_code, x.number });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    user_id = table.Column<string>(nullable: false),
                    country_code = table.Column<string>(nullable: false, defaultValue: "55"),
                    area_code = table.Column<string>(nullable: false),
                    number = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Phone", x => new { x.user_id, x.number, x.country_code, x.area_code });
                    table.ForeignKey(
                        name: "FK_Phone_AspNetUsers_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
